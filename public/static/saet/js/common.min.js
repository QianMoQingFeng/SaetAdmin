...
St.message = LAST_IS_HOME ? ElementPlus.ElMessage : parent.window.ElementPlus.ElMessage;
St.loading = LAST_IS_HOME ? ElementPlus.ElLoading : parent.window.ElementPlus.ElLoading;
St.notify = LAST_IS_HOME ? ElementPlus.ElNotification : parent.window.ElementPlus.ElNotification;
St.cookie = Cookies;
