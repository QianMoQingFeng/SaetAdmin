<?php /*a:5:{s:76:"/media/psf/qianmokeji/SaetAdmin/saet.io/app/admin/view/admin/token/index.vue";i:1666182235;s:36:"../app/admin/view/public/layout.html";i:1666663026;s:36:"../app/admin/view/public/header.html";i:1666258581;s:36:"../app/admin/view/public/assgin.html";i:1666258650;s:36:"../app/admin/view/public/script.html";i:1667032728;}*/ ?>
<!DOCTYPE html>
    ...
    new SaetApp({
        setup() {
            const fields = [
                ...
                { name: 'token', title: 'Token', case: 'copy' },
                { name: 'create_time', title: '创建时间', search: { type: 'datetimerange' } },
                { name: 'create_time', title: '生效时间', search: { type: 'datetimerange' } },
                { name: 'expire_time', title: '失效时间', search: { type: 'datetimerange' } },
                { name: 'is_temporary', title: '是否临时', case: 'switch', search: { type: 'radio' } },
                { case: 'operation' }
            ]
            return { fields }
        }
