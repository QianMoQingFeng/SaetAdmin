<?php /*a:5:{s:76:"/media/psf/qianmokeji/SaetAdmin/saet.io/app/admin/view/admin/admin/index.vue";i:1667224252;s:36:"../app/admin/view/public/layout.html";i:1666663026;s:36:"../app/admin/view/public/header.html";i:1666258581;s:36:"../app/admin/view/public/assgin.html";i:1666258650;s:36:"../app/admin/view/public/script.html";i:1667224275;}*/ ?>
<!DOCTYPE html>
    ...
    new SaetApp({
        setup() {
            const fields = [
                ...
                { name: 'create_time', title: '注册时间', search: [{ type: 'daterange' }, { type: 'monthrange' }, { type: 'datetimerange' }] },
                { name: 'online_time', title: '上线时间', search: [{ type: 'day' }, { type: 'year' }] },
                { case: 'operation' },
            ]
            const config = { pk: 'aid', search: true, page: { size: 1 } }
