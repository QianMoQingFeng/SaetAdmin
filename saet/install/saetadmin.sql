...
CREATE TABLE `st_admin` (
  ...
  `group_ids` varchar(255) DEFAULT NULL COMMENT '分组ID',
...
CREATE TABLE `st_admin_token` (
  ...
  `token` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Token',
  ...
  `app` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'free' COMMENT '执行应用',
...
CREATE TABLE `st_admin_group` (
  ...
  `rule_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '规则',
  `badge` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '徽章',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `status` enum('normal','disabled') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
...
CREATE TABLE `st_admin_rule` (
  ...
  `addons` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'system' COMMENT '来源插件',
  `url` varchar(255) DEFAULT NULL COMMENT '规则路径',
  `param` json DEFAULT NULL COMMENT '参数',
  `title` varchar(255) DEFAULT NULL COMMENT '标题',
  `desc` varchar(255) DEFAULT NULL COMMENT '描述',
  `icon` varchar(255) DEFAULT NULL COMMENT '图标',
  `is_addons_nav` int DEFAULT '0' COMMENT '是否插件导航',
  `is_menu_nav` int DEFAULT '0' COMMENT '是否菜单导航',
  `addons_nav_type` varchar(255) DEFAULT NULL COMMENT '插件导航类型',
  `nav_type` enum('tab','popup','jump','ajax') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '菜单导航类型',
  ...
  `status` enum('normal','disabled','skip') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'normal' COMMENT '状态',
  PRIMARY KEY (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (1, 0, 'system', 'home/dashboard', NULL, '控制台', NULL, 'ri-group-line', 0, 1, NULL, NULL, NULL, NULL, NULL, '2022-09-21 16:46:26', 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (2, 0, 'more_module', 'more_module', '{}', '多应用插件', NULL, 'Bicycle', 0, 1, 'tab', 'tab', NULL, NULL, NULL, '2022-09-19 13:57:22', 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (3, 0, 'development_demo', 'dada', '{\"a\": \"b\"}', '开发示例', NULL, 'Bicycle', 0, 1, 'tab', 'tab', NULL, NULL, NULL, '2022-10-20 21:36:44', 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (4, 0, 'development_demo', 'edoc/doc/index1', NULL, '简单的表格', NULL, 'ri-checkbox-blank-circle-line', 0, 1, NULL, NULL, NULL, NULL, NULL, '2022-09-19 13:19:25', 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (5, 0, 'system', 'addon/index', NULL, '插件中心', NULL, 'ri-app-store-fill', 0, 0, NULL, NULL, NULL, NULL, NULL, '2022-10-20 17:41:53', 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (6, 0, 'system', 'config/index', NULL, '系统设置', NULL, 'ri-settings-2-fill', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (7, 0, 'system', 'admin', NULL, '后台权限', NULL, 'ri-admin-fill', 0, 1, 'tab', 'tab', NULL, NULL, NULL, '2022-09-19 13:19:25', 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (28, 7, 'system', 'admin.admin/index', NULL, '管理员', NULL, 'ri-user-3-line', 0, 1, 'tab', 'tab', NULL, NULL, NULL, NULL, 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (29, 7, 'system', 'admin.group/index', NULL, '角色组', NULL, 'ri-group-line', 0, 1, 'tab', 'tab', NULL, NULL, NULL, NULL, 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (30, 7, 'system', 'admin.rule/index', NULL, '权限规则', NULL, 'ri-list-settings-fill', 0, 1, 'tab', 'tab', NULL, NULL, NULL, NULL, 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (31, 7, 'system', 'admin.token/index', NULL, 'Token密钥', NULL, 'ri-key-2-fill', 0, 1, 'tab', 'tab', NULL, NULL, NULL, NULL, 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (100, 0, 'edoc', 'edoc', NULL, '文档管理', NULL, 'ri-key-2-fill', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'normal');
INSERT INTO `st_admin_rule` (`id`, `pid`, `addons`, `url`, `param`, `title`, `desc`, `icon`, `is_addons_nav`, `is_menu_nav`, `addons_nav_type`, `nav_type`, `first_letter`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (101, 100, 'edoc', 'edoc/doc/index', NULL, '文档列表', NULL, 'ri-key-2-fill', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'normal');
COMMIT;
-- ----------------------------
...
CREATE TABLE `st_config` (
  ...
  `option` varchar(5000) COLLATE utf8mb4_general_ci DEFAULT NULL,
